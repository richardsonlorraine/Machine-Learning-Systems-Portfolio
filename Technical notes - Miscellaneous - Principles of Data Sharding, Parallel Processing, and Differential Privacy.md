...
* Horizontal Scaling: Sharding is a database architecture pattern where a large dataset is partitioned into smaller, autonomous pieces called shards, distributed across multiple nodes.
...
Simultaneous Execution Parallel processing breaks a single computational task into independent sub-tasks executed concurrently.
...
IV. Python Simulation: Parallel Processing & Noise 
